					...
					<div class="item-wrapper">
						...
						<div class="item-details">
							<div class="item-details-wrapper">
								<h3 class="product-name"><?php echo esc_attr( apply_filters( 'woocommerce_in_cartproduct_obj_title', $product->get_title(), $product ) ); ?></h3>
