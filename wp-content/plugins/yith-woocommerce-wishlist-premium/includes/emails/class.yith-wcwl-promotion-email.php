		...
		public function init_form_fields() {
			$this->form_fields = array(
				...
				'content_html' => array(
					...
					'type' 			=> 'textarea',
					'description' 	=> sprintf( __( 'This field lets you modify the main content of the HTML email. You can use the following placeholders: %s', 'yith-woocommerce-wishlist' ), $this->get_placeholder_text( 'html' ) ),
					'placeholder' 	=> '',
					'css'         => 'min-height: 250px;',
					'default' 		=> __( '<p>Hi {user_name}</p>
...
<p>Use this coupon code <b><a href="{add_to_cart_url}">{coupon_code}</a></b> to get an amazing discount!</p>', 'yith-woocommerce-wishlist' ),
                    ),

				'content_text' => array(
					'title' 		=> __( 'Email text content', 'yith-woocommerce-wishlist' ),
					'type' 			=> 'textarea',
					'description' 	=> sprintf( __( 'This field lets you modify the main content of the text email. You can use the following placeholders: %s', 'yith-woocommerce-wishlist' ), $this->get_placeholder_text( 'plain' ) ),
					'placeholder' 	=> '',
					'css'         => 'min-height: 250px;',
...
{coupon_code}
to get an amazing discount!', 'yith-woocommerce-wishlist' ),
				)
			);
		}
		...
		public function get_placeholder_text( $email_type ) {
			if( 'plain' == $email_type ){
				return '<code>{user_name}</code> <code>{user_email}</code> <code>{user_first_name}</code> <code>{user_last_name}</code> <code>{product_image}</code> <code>{product_name}</code> <code>{product_price}</code> <code>{coupon_code}</code> <code>{coupon_amount}</code> <code>{add_to_cart_url}</code>';
			}
			else{
				return '<code>{user_name}</code> <code>{user_email}</code> <code>{user_first_name}</code> <code>{user_last_name}</code> <code>{product_image}</code> <code>{product_name}</code> <code>{product_price}</code> <code>{coupon_code}</code> <code>{coupon_amount}</code> <code>{add_to_cart_url}</code>';
			}
