		...
		public function column_date( $item ) {
			...
			if( isset( $item['dateadded'] ) ){
				...
				if( $time_diff < DAY_IN_SECONDS ){
					...
					$row = mysql2date( _x( 'Y/m/d', 'This is a date format: translate only to change format, referring date() php function for available placeholders', 'yith-woocommerce-wishlist' ), $item['dateadded'] );
				}
			}
